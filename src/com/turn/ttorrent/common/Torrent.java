 ...
 * @author mpetazzoni
 * @see
 * <a href="http://wiki.theory.org/BitTorrentSpecification#Metainfo_File_Structure">Torrent
...
public class Torrent {
     ...
     * @throws IOException When the info dictionary can't be read or encoded and
     * hashed back to create the torrent's SHA-1 hash.
     ...
     * </p>
     *
     * @param parent The parent directory or location of the torrent files, also
     ...
     *
     * @param source The file to use in the torrent.
     * @param announceList The announce URIs organized as tiers that will be
     * used for this torrent
     * @param createdBy The creator's name, or any string identifying the
     * torrent's creator.
     */
