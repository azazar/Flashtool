...
public class CircularByteBuffer {
    ...
    protected class CircularByteBufferInputStream extends InputStream {
         ...
         *
         * @param readAheadLimit Limit on the number of bytes that may be read
         * while still preserving the mark. After reading this many bytes,
    ...
    protected class CircularByteBufferOutputStream extends OutputStream {
         ...
         * @throws BufferOverflowException if buffer does not allow blocking
         * writes and the buffer is full. If the exception is thrown, no data
