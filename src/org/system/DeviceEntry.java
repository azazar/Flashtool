...
public class DeviceEntry {
 ...
 /*public void setDefaultRecovery() throws Exception {
    ...
    public String getProtocol() {
        if (_entry.getProperty("flashProtocol") == null) {
            return "S1";
        }
    ...
    public void addVariantToList(String model) {
        ...
        if (current.length() == 0) {
            _entry.setProperty("variant", model);
        }
        else {
    ...
    public String getBusybox(boolean select) {
        String version = "";
        if (!select) {
            version = _entry.getProperty("busyboxhelper");
        }
        else {
        ...
        if (version.length() == 0) {
            ...
            return OS.getFolderDevices() + File.separator + "busybox" + File.separator + version + File.separator + "busybox";
        }
    }
 ...
 /*public HashSet<DeviceEntryModel> getModels() {
    ...
    public boolean isFlashScriptMandatory() {
        if (!_entry.getProperties().containsKey("fscmandatory")) {
            return false;
        }
