...
public class S1Packet {
    ...
    public boolean isHeaderOK() {
        if (headercksum == 0 && getCommandName().length() > 0 && (getFlag() == 1 || getFlag() == 3 || getFlag() == 7)) {
            return true;
        }
    ...
    public String getCommandName() {
        ...
        if (getCommand() == 0x06) {
            return "Send sin data";
        }
        if (getCommand() == 0x19) {
            return "setLoaderConfig";
        }
        if (getCommand() == 0x04) {
            return "End flashing";
        }
