...
public final class ERandomAccessFile extends RandomAccessFile {
     ...
     * bytes are read. This method blocks until the requested number of bytes
     * are read, the end of the stream is detected, or an exception is thrown.
     * </p>
     * <p>
     * <em>This method converts the read buffer according to the set
     * endianness!</em>
     * </p>
     *
     ...
     * <code>b6</code>, <code>b7</code>, and <code>b8,</code> where: <tt>
     ...
     * then the result is equal to: <tt>
     * (short)((b1 &lt;&lt; 8) | b2)
     * </tt></p>
     * <p>
    ...
    /**
     * Sets whether the (long) words are to be interpreted in big or little
     * endian mode.
     *
     * @param aLittleEndian <code>true</code> if data is expected to be little
     * endian, <code>false</code> otherwise.
     */
