...
public class Section {
     ...
     *
     * @return <code>true</code> if this section holds a table,
     ...
     * section holds a double word, the system must ensure double word alignment
    ...
    /**
     * Returns the byte offset from the beginning of the file to the first byte
     * in the section. One section type, SHT_NOBITS, occupies no space in the
    ...
    /**
     * Returns a section header table index link, whose interpretation depends
     * on the section type.
     *
    ...
    /**
     * Returns the extra information, whose interpretation depends on the
     * section type.
     *
    ...
    /**
     * If this section contains a table, this method returns the number of
     ...
     *
     * @param aHeader the ELF header to use;
     * @param aFile the ELF-file to read the symbols from.
