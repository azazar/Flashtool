...
public class Elf {
    ...
    /**
     * This section describes the default string table. String table sections
     * hold null-terminated character sequences, commonly called strings. The
     * object file uses these strings to represent symbol and section names.
     *
