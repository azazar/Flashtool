...
public class ProgramHeader {
    ...
    /* Segment is readable */
    public static final int PF_PAGEEXEC = (1 << 4);
    /* Enable PAGEEXEC */
    public static final int PF_NOPAGEEXEC = (1 << 5);
    /* Disable PAGEEXEC */
    public static final int PF_SEGMEXEC = (1 << 6);
    /* Enable SEGMEXEC */
    public static final int PF_NOSEGMEXEC = (1 << 7);
    /* Disable SEGMEXEC */
    public static final int PF_MPROTECT = (1 << 8);
    /* Enable MPROTECT */
    public static final int PF_NOMPROTECT = (1 << 9);
    /* Disable MPROTECT */
    public static final int PF_RANDEXEC = (1 << 10);
    /* Enable RANDEXEC */
    public static final int PF_NORANDEXEC = (1 << 11);
    /* Disable RANDEXEC */
    public static final int PF_EMUTRAMP = (1 << 12);
    /* Enable EMUTRAMP */
    public static final int PF_NOEMUTRAMP = (1 << 13);
    /* Disable EMUTRAMP */
    public static final int PF_RANDMMAP = (1 << 14);
    /* Enable RANDMMAP */
    public static final int PF_NORANDMMAP = (1 << 15);
    /* Disable RANDMMAP */
 ...
 /* NOTE: 64 bit and 32 bit ELF have different order and size of elements */
     ...
     * segments are aligned in memory and in the file. Values 0 and 1 mean that
     * no alignment is required. Otherwise, p_align should be a positive,
     * integral power of 2, and p_addr should equal p_offset, modulo p_align.
     *
     ...
     * reserved for the segment's physical address. This member requires
