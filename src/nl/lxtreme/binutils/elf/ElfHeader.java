...
public class ElfHeader {
 ...
 /* OpenRISC 32-bit embedded processor */
     ...
     *
     * @param bytes the binary header to convert to a header.
     * @throws IOException in case the given bytes did not look like a valid ELF
     * header.
     */
     ...
     *
     * @param e_ident the byte array to test, cannot be <code>null</code>.
    ...
    /**
     * Returns the machine type, or required architecture for an individual
     * file.
     *
     ...
     * {@link #getProgramHeaderEntryCount()} gives the table's size in bytes. If
     * a file has no program header table, this method returns zero.
     *
    ...
    /**
     * Returns the program header table's file offset in bytes. If the file has
     * no program header table, this method returns zero.
     *
    ...
    /**
     * Returns the number of entries in the section header table. Thus the
    ...
    /**
     * Returns the section header table's file offset in bytes. If the file has
     ...
     *
     * @return <code>true</code> if there are entries in the program header
     ...
     *
     * @return <code>true</code> if the ELF's data is expected to be big endian,
     * <code>false</code> if it is expected to be little endian or unknown.
     */
     ...
     * endian, <code>false</code> if it is expected to be big endian or unknown.
     */
