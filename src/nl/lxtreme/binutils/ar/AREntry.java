...
/**
 * The <code>ARHeader</code> class is used to store the per-object file archive
 * headers. It can also create an Elf object for inspecting the object file
 * data.
 */
public class AREntry {
     ...
     *
     * @return <code>true</code> if this header represents a string table
     ...
     * extended filename.
     *
     * @return <code>true</code> if this header is an extended filename created
     * by BSD ar, <code>false</code> otherwise.
     */
     ...
     *
     * @return <code>true</code> if this header is an extended filename created
     * by GNU ar, <code>false</code> otherwise.
     */
