...
public class AR {
     ...
     * @throws IllegalArgumentException in case the given file was
     * <code>null</code>;
     ...
     * <code>null</code>;
     * @param aNames the names of the files to extract, if omitted all files
     * will be extracted.
     * @throws IllegalArgumentException in case the given output directory was
     * <code>null</code>;
     ...
     * @throws IllegalArgumentException in case either one of the given
     * arguments was <code>null</code>;
     * @throws IOException in case of I/O problems.
     */
     ...
     *
     * @param aOffset Offset into the string table for first character of the
     * name.
     ...
     * @return <code>true</code> if the given subject was found in the given
