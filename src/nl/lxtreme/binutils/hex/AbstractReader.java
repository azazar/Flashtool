...
public abstract class AbstractReader {
     ...
     *
     * @return the next byte, can be <code>-1</code> in case an end-of-stream
     * was encountered.
     * @throws IOException in case of stream I/O problems;
     */
     ...
     * Reads a number of bytes in the given buffer.
     *
     * @return the next long word, can be <code>-1</code> in case an
     ...
     * @return a byte array with the read bytes, can be <code>null</code> in
     * case an EOF was found.
