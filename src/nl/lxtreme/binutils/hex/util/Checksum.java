...
public enum Checksum {
     ...
     *
     * @param aValues the values to calculate the checksum for, should be at
     * least two values.
     * @return the 8-bit checksum.
     * @throws IllegalArgumentException in case the given values were
     * <code>null</code> or did not contain at least two values.
     */
     ...
     * @throws IllegalArgumentException in case the given values were
     * <code>null</code> or did not contain at least one value.
     */
