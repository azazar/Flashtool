...
public final class HexUtils {
     ...
     * @return a byte value.
     * @throws IllegalArgumentException in case the given char sequence was
     * <code>null</code>, in case the given input did not yield a hex-byte, or
     * the requested offset is outside the boundaries of the given char
     * sequence.
     */
     ...
     * Parses the hex-byte in the given character sequence at the given offset.
     *
     * @param aInput the char sequence to parse as hex-bytes;
     * @param aOffset the offset in the char sequence to start parsing.
     * @return a byte value.
     * @throws IllegalArgumentException in case the given char sequence was
     * <code>null</code>, in case the given input did not yield a hex-byte, or
     * the requested offset is outside the boundaries of the given char
     ...
     * @param aByteCount the number of bytes to read (= 2 * amount of actual
     * characters read).
     * @return the parsed number.
     * @throws IllegalArgumentException in case the given reader was
     * <code>null</code> or the given byte count was <= 0. @ throws IOException
