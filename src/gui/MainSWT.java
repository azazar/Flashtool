...
public class MainSWT {
     ...
     */
    public void open() {
        if (GlobalConfig.getProperty("gitauto") == null) {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (result == null) {
                    ...
                    for (int i = 0; i < result.getBags().size(); i++) {
                        if (result.getBags().get(i).toflash.size() > 0) {
                            toflash = true;
                        }
                    }
                    if (!toflash) {
    ...
    public void doRoot() {
        ...
        else if (Devices.getCurrent().getVersion().contains("4.2")) {
            rj.setAction("doRootPerfEvent");
        }
        else if (Devices.getCurrent().getVersion().contains("4.1")) {
        ...
        else if (Devices.getCurrent().getVersion().contains("2.3")) {
